...
STATEMENTS_OUT = "statements_start-1900_v2.jsonl"
PROOFS_OUT = "proofs_start-1900_v2.jsonl"
...
def assign_ids_and_attach(statements, proofs, paper_id):
    ...
    with open(STATEMENTS_OUT, "w", encoding="utf-8") as sf, \
        ...
        for dirpath in pbar:
            ...
            try:
                ...
                proofs = extract_proofs(cleaned, paper_id)
                statements, proofs = assign_ids_and_attach(statements, proofs, paper_id)
